...
% Return the path to the root ISETBioJandJ directory
%
% Syntax:
%   rootPath = ISETBioJandJRootPath;
%
% Description:
%    This points at the top level of the ISETBioJandJ tree on the Matlab path.
%
